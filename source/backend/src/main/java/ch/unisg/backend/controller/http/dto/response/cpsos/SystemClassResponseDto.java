...
public class SystemClassResponseDto extends ResponseDto {
  ...
  private SystemClassResponseDto(UUID id, String title, boolean isCyber) {
    this.id = id;
    this.title = title;
  ...
  public static HashMap<String, Object> toJson(SystemClass systemClass) {
    ...
    result.put("isCyber", systemClass.isCyber());
    result.put("issueList", IssueResponseDto.toJson(systemClass.getIssueList()));
    result.put("nonFunctionalRequirementList", NonFunctionalRequirementResponseDto
        .toNonFunctionalRequirementResponseDtoList(systemClass.getNonFunctionalRequirementList()));
