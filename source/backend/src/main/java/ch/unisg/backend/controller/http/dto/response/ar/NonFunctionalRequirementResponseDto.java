...
public class NonFunctionalRequirementResponseDto {
  ...
  public static HashMap<String, Object> create(NonFunctionalRequirement nonFunctionalRequirement) {
    ...
    result.put("isCyber", nonFunctionalRequirement.isCyber());

    return result;
  }

  public static List<HashMap<String, Object>> toNonFunctionalRequirementResponseDtoList(
      List<NonFunctionalRequirement> nonFunctionalRequirementList) {
