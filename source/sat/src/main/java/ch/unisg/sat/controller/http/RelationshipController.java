...
import ch.unisg.sat.controller.http.dto.request.entity.relationship.*;
import ch.unisg.sat.controller.http.dto.response.ar.ForcedByResponseDto;
import ch.unisg.sat.controller.http.dto.response.relationship.*;
import ch.unisg.sat.core.port.in.RelationshipManagerUseCase;
import ch.unisg.sat.core.port.in.command.classes.*;
