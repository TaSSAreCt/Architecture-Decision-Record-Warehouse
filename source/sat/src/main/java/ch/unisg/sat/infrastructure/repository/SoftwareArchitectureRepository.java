...
import ch.unisg.sat.core.port.out.SoftwareArchitecturePort;
import ch.unisg.sat.infrastructure.repository.mapper.ArchitecturalDecisionListMapper;
import ch.unisg.sat.infrastructure.repository.mapper.ArchitecturalKnowledgeMapper;
import ch.unisg.sat.infrastructure.repository.mapper.SystemElementAggregateListMapper;
import ch.unisg.sat.infrastructure.repository.mapper.SystemMapper;
import ch.unisg.sat.infrastructure.repository.mapper.ar.NonFunctionalRequirementListMapper;
import ch.unisg.sat.infrastructure.repository.sdn.api.ArchitectureRationaleCypherPort;
import ch.unisg.sat.infrastructure.repository.sdn.api.IssueCypherPort;
import ch.unisg.sat.infrastructure.repository.sdn.api.SystemCypherPort;
...
public class SoftwareArchitectureRepository implements SoftwareArchitecturePort {
     ...
     */
    @Override
    public void getSoftwareArchitecture(SoftwareArchitecture softwareArchitecture) {
